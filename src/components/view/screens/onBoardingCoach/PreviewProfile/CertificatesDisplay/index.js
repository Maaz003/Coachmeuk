...
import ViewCertificateModal from '@components/view/modal/StudentModals/ViewCertificateModal';
...
function CertificatesDisplay(props) {
  ...
  return (
    <View style={[styles.mainLayout]}>
      ...
      />
      <ViewCertificateModal isVisibleModal={isModal} modalData={modalData} />
    </View>
  );
}
