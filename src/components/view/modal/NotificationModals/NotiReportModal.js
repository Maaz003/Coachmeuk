...
function NotiReportModal(props) {
  ...
  return (
    <>
      ...
      <NotiInfoModal
        ...
        text={
          'Thanks for your feedback. We’re working hard to solve any difficulties that might happen. We’ll get back to you.'
        }
        secondaryButtonText={'Contact Lytesnap'}
      />
    </>
  );
}
...
export default NotiReportModal;
