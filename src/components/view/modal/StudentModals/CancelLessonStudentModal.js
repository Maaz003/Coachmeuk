...
function CancelLessonStudentModal(props) {
  ...
  const reportData = [
    ...
    {id: 3, title: 'Other (nothing from the above)', isChecked: false},
  ];
    ...
    <>
      <Modal
        ...
        <LessonStatusModal
          ...
          primaryButtonText={'Book another lesson'}
...
export default CancelLessonStudentModal;
